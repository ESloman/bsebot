...
from discordbot.slashcommandeventclasses import BSEddiesAutoGeneratedBets, BSEddiesHighScore
...
class CommandManager(object):
    ...
    def _register_slash_commands(self, guilds: list) -> None:
        ...
        async def admin_give_user_eddies(
            ...
            """
            Slash command for allowing the user to give a user some eddies.
            :param ctx:
            :param user:
            :param amount:
            :return:
