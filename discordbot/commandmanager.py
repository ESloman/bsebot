...
from discordbot.slashcommandeventclasses import BSEddiesKing, BSEddiesPredict
...
class CommandManager(object):
    ...
    def _register_slash_commands(self, guilds: list) -> None:
        ...
        @self.slash.subcommand(
            ...
            base_description="View your BSEddies, create bets and resolve bets",
            name="predict",
            description="See your estimated salary gain for today so far",
            guild_ids=guilds)
        async def predict(ctx: discord_slash.context.SlashContext) -> None:
            """
