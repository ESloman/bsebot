...
class BlessAmountSelect(Select):
    amounts = [
        100, 250, 500, 750, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 10000
    ]
...
class BlessClassSelect(Select):
    values = [
        ("all", "All the recently active server member"),
        ("supporters", "Your loyal followers only")
    ]

    def __init__(self):
        options = [
            SelectOption(label=opt[0], value=opt[0], description=opt[1]) for opt in self.values
        ]
