...
class BSEddiesCloseBet(BSEddies):
    ...
    async def create_bet_view(
        ...
        await ctx.respond(content="**Placing a bet**", view=close_bet_view, ephemeral=True)
...
class BSEddiesCreateBet(BSEddies):
    ...
    async def handle_bet_creation(
        ...
        followup = ctx.followup  # type: discord.Webhook
        await followup.send(content="Created bet for you.", ephemeral=True)
...
#         )
#
#         if scenario_type == "pook":
#             if ctx.channel_id != 884720128695107594:
#                 await ctx.send("Need to be in the secret pook channel to use this option.", hidden=True)
#                 return
#
...
#             "project_zomboid": "sudo systemctl start pzserver.service"
#         }
...
#             "project_zomboid": "sudo systemctl stop pzserver.service"
#         }
#
