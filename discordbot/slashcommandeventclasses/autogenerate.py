...
class BSEddiesAutoGenerate(BSEddies):
    ...
    def __init__(self, client, guilds, logger):
        ...
        self.bet = BSEddiesCreateBet(client, guilds, logger)
        self.auto_bets = AutoGeneratedBets()
        self.place = BSEddiesPlaceBet(client, guilds, logger)
        self.close = BSEddiesCloseBet(client, guilds, logger)

    async def create_auto_generate_view(self, ctx: discord.ApplicationContext):
        view = views.AutoGenerateView(self)
