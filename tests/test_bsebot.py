...
from tests.mocks import bsebot_mock
...
class TestBSEBot:
    ...
    @patch.object(discord.Bot, "get_guild", new=bsebot_mock.get_guild)
    ...
    @patch.object(discord.Bot, "get_guild", new=bsebot_mock.get_guild)
    @patch.object(discord.Bot, "fetch_guild", new=bsebot_mock.fetch_guild)
    ...
    @patch.object(discord.Bot, "get_channel", new=bsebot_mock.get_channel)
    ...
    @patch.object(discord.Bot, "get_channel", new=bsebot_mock.get_channel)
    @patch.object(discord.Bot, "fetch_channel", new=bsebot_mock.fetch_channel)
